...
def conversacion():
    ...
    dialogo1=[f"Naruto \n\nHola {Mapa[zmapa][0]}.",
             ...
             f"{Mapa[zmapa][0]} \n\nPues de hecho estaba en {Mapa[lugar_random][1]}, y ahora que lo pienso, recuerdo haber \nvisto a {Mapa[nombre_random][0]} rondando por el lugar.\nQuizas encuentren algo util....",
    ...
    dialogos=[[f"{Mapa[zmapa][0]} \n\nHola chicos, oigan, y Saitama?",
            ...
            [f"Luffy \n\nQue onda, {Mapa[zmapa][0]}? \nVengan acá nakamas",
                 ...
                 f"{Mapa[zmapa][0]} \n\nEstaba bebiendo en ROSCOE. De hecho tengo el recibo si no me creen.",
